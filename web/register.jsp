    ...
    <form class="form-horizontal" action="/action_page.php">
        <div class="form-group">
            ...
            <div class="col-sm-10 rame">
                <input type="text" class="form-control" style="width: 226px;" id="name" placeholder="Podaj Imię" name="pwd">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 rame">
                <input type="text" class="form-control" style="width: 226px;" id="surname" placeholder="Podaj Nazwisko" name="pwd">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 rame" style="width: 226px;margin-top: 8px;margin-bottom: 8px;">
                <input type="text" class="form-control" style="width: 226px;" id="nickname" placeholder="Podaj nick" name="pwd">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 rame" style="width: 226px;margin-top: 8px;margin-bottom: 8px;">
                <input type="number" class="form-control" style="width: 226px;" id="phone" placeholder="Podaj telefon" name="pwd">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 rame">
                <input type="email" class="form-control" style="width: 226px;" id="email" placeholder="Podaj email" name="email">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" class="form-control" style="width: 226px;" id="pwd" placeholder="Wprowadź hasło" name="pwd">
            </div>
        </div>
